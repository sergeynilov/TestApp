@props(['preselectValues' => '', 'idSelect', 'name'])

<div class="w-full" x-data="alpineMuliSelect({selected:[{{ $preselectValues }}], elementId:'{{ $idSelect }}'})">

    <select style="display:none;" id="{{ $idSelect }}">
                        ...
                        <div class="flex flex-auto flex-wrap" x-on:click="open">
                            ...
                            <template x-for="(option, index) in selectedElms" :key="option.value">
                                ...
                                >
                                    <div class="text-xs font-normal leading-none max-w-full flex-initial"
                                         x-model="selectedElms[option]" x-text="option.text">
                                    </div>
                            ...
                            <div x-show="selectedElms.length > 2"
                                 class="flex justify-center items-center m-1 font-medium py-1 px-2 rounded-full
                                        text-indigo-700 bg-indigo-100 border border-indigo-300"
                            >
                                <div class="text-xs font-normal h-6 flex justify-center items-center leading-none
                                            max-w-full flex-initial"
                                >
                                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-sm
                                                 font-medium bg-indigo-200 text-pink-800 mr-2"
                                    >
                ...
                <div class="w-full">
                    ...
                    >
                        <div class="flex flex-col w-full">
                            ...
                            <div class="px-2 py-4 border-b-2">
                                ...
                                <div class="mt-1 relative rounded-md shadow-sm">
                                    ...
                                    <input type="text"
                                           ...
                                           class="focus:ring-indigo-500 focus:border-indigo-500 block w-full pl-10
                                                  sm:text-sm border border-indigo-300 rounded-md h-10"
                                           @keyup.escape="clear"
                                    ...
                                    <div class="absolute inset-y-0 right-0 flex py-1.5 pr-1.5">
                                        ...
                                        <kbd class="inline-flex items-center border border-gray-200 rounded px-2
                                                    text-sm font-sans font-medium text-gray-400 mr-2"
                                             x-on:click="clear"
                                        >
                                            Esc
                                        </kbd>
                                        ...
                                        <kbd class="inline-flex items-center border border-gray-200 rounded px-2
                                                    text-sm font-sans font-medium text-gray-400"
                                             x-on:click="deselect"
                                        >
                                            Del
                                        </kbd>
                            ...
                            <!-- Options container -->
                            <ul class="z-10 mt-0 w-full bg-white shadow-lg max-h-80 rounded-md py-0 text-base ring-1
                                       ring-black ring-opacity-5 focus:outline-none  overflow-y-auto sm:text-sm"
                                tabindex="-1"
                                role="listbox"
                                @keyup.delete="deselect"
                            >
